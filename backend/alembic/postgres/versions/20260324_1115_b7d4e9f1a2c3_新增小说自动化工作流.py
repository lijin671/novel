...
def upgrade() -> None:
    ...
    op.add_column('batch_generation_tasks', sa.Column('enable_workflow', sa.Boolean(), nullable=True, comment='是否启用自动化全流程'))
    op.add_column('batch_generation_tasks', sa.Column('workflow_auto_regenerate', sa.Boolean(), nullable=True, comment='工作流是否自动返工'))
    op.add_column('batch_generation_tasks', sa.Column('workflow_max_rounds', sa.Integer(), nullable=True, comment='工作流最大返工轮次'))
    op.add_column('batch_generation_tasks', sa.Column('workflow_min_score', sa.Float(), nullable=True, comment='工作流通过阈值'))


def downgrade() -> None:
    op.drop_column('batch_generation_tasks', 'workflow_min_score')
    op.drop_column('batch_generation_tasks', 'workflow_max_rounds')
    op.drop_column('batch_generation_tasks', 'workflow_auto_regenerate')
    op.drop_column('batch_generation_tasks', 'enable_workflow')
