...
class BookRemixContinuationContextPreviewResponse(BaseModel):
    ...
    portable_project_memory_warnings: list[str] = Field(default_factory=list)
    ...
    post_draft_review_warnings: list[str] = Field(default_factory=list)
    canonkit_context_pack_warnings: list[str] = Field(default_factory=list)
    ...
    intake_export_rollback_warnings: list[str] = Field(default_factory=list)
    context_scope_authority_warnings: list[str] = Field(default_factory=list)
    local_first_authoring_warnings: list[str] = Field(default_factory=list)
    deterministic_volume_spec_warnings: list[str] = Field(default_factory=list)
    raw_story_assimilation_warnings: list[str] = Field(default_factory=list)
    ...
    human_oversight_quality_warnings: list[str] = Field(default_factory=list)
