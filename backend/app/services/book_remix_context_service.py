...
def build_remix_context_preview_audit(
    *,
    ...
    return {
        ...
        "intake_export_rollback_warnings": production_control_audit["intake_export_rollback_warnings"],
        "context_scope_authority_warnings": production_control_audit["context_scope_authority_warnings"],
        "local_first_authoring_warnings": production_control_audit["local_first_authoring_warnings"],
