...
- NovelForge, autonovel, KoboldAI, SillyTavern, ai_rpg and Memoria sources were read only as public text metadata; no source code import or runtime trial was performed.
