    ...
    <div>
      <Button
        ...
        onMouseEnter={(event) => {
          ...
          event.currentTarget.style.boxShadow = hoverButtonShadow;
        }}
        onMouseLeave={(event) => {
          event.currentTarget.style.transform = 'translateY(0)';
          event.currentTarget.style.boxShadow = primaryButtonShadow;
        }}
      >
        使用 LinuxDO OAuth 登录
      </Button>
              ...
              >
                ...
                <Space direction="vertical" size={32} style={{ width: '100%' }}>
                  <div style={{ maxWidth: 'min(860px, 100%)' }}>
                    ...
                    >
                      从灵感到成稿，围绕多模型协同、创作流程自动化、角色关系管理和章节精修构建一体化创作工作台。
                    </Paragraph>
                  </div>
