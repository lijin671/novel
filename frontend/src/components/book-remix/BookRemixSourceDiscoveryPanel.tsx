...
const PINNED_HINT_KEYS = new Set([
  ...
  'universal_scene_surface_craft_gate_hints',
        ...
        <Space direction="vertical" size={16} style={{ width: '100%' }}>
          ...
          <Space direction="vertical" size={12} style={{ width: '100%' }}>
            ...
            {renderHintGroup('Universal novel-writing skill gates', [
              ...
              ['Universal story-engine scene-pressure gates', patternPackPayload?.universal_story_engine_scene_pressure_gate_hints],
              ['Scene-surface craft gates', patternPackPayload?.universal_scene_surface_craft_gate_hints],
              ['Character / world-rule coherence gates', patternPackPayload?.universal_character_world_rule_coherence_gate_hints],
              ['Story Skills deterministic continuity gates', patternPackPayload?.story_skills_deterministic_continuity_contract_gate_hints],
              ['Better Writing voice specificity preflight gates', patternPackPayload?.better_writing_voice_specificity_preflight_gate_hints],
              ...
              ['Startup status / context recovery gates', patternPackPayload?.startup_status_context_recovery_gate_hints],
            ...
            {renderHintGroup('Writing benchmark / judge gates', [
              ...
              ['SAGA TUI/adversarial publishing gates', patternPackPayload?.saga_tui_adversarial_publish_gate_hints],
              ['Four-agent chapter quality-loop gates', patternPackPayload?.four_agent_chapter_quality_loop_gate_hints],
              ['Volume rolling spec-quality gates', patternPackPayload?.volume_rolling_spec_quality_gate_hints],
              ['Executor-agnostic instruction checkpoint gates', patternPackPayload?.executor_agnostic_instruction_checkpoint_gate_hints],
              ['Novel Studio accepted-chapter memory gates', patternPackPayload?.novel_studio_accepted_chapter_memory_gate_hints],
              ['Dynamic world tick / information horizon gates', patternPackPayload?.dynamic_world_tick_info_horizon_gate_hints],
              ['Editorial firewall / contract diagnosis gates', patternPackPayload?.editorial_firewall_contract_diagnosis_gate_hints],
