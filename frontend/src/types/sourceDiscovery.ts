...
export interface SourceDiscoveryPatternPack {
  ...
  universal_scene_surface_craft_gate_hints?: string[];
  universal_character_world_rule_coherence_gate_hints?: string[];
  ...
  progressive_context_loading_gate_hints?: string[];
  startup_status_context_recovery_gate_hints?: string[];
  author_intent_confirmation_gate_hints?: string[];
  ...
  pacing_arc_polish_pass_gate_hints?: string[];
  ...
  editorial_firewall_contract_diagnosis_gate_hints?: string[];
