...
export interface BookRemixContinuationContextPreview {
  ...
  portable_project_memory_warnings: string[];
  ...
  post_draft_review_warnings: string[];
  canonkit_context_pack_warnings: string[];
  genre_promise_contract_warnings: string[];
  subgenre_ledger_warnings: string[];
  intake_export_rollback_warnings: string[];
  context_scope_authority_warnings: string[];
  local_first_authoring_warnings: string[];
  deterministic_volume_spec_warnings: string[];
  raw_story_assimilation_warnings: string[];
  ...
  character_world_rule_coherence_warnings: string[];
  story_skills_continuity_contract_warnings: string[];
  better_writing_voice_preflight_warnings: string[];
